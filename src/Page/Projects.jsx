          ...
          <div className="projects-mid">
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={guess} alt="guess-the-number" />
              </a>
            ...
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={roll} alt="roll-the-dice" />
              </a>
            ...
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={tindog} alt="tindog" />
              </a>
            ...
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={drumkit} alt="drumkit" />
              </a>
            ...
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={simon} alt="simon-says" />
              </a>
            ...
            <div className="pro">
              <a
                ...
                target="_blank"
              >
                <img className="projects-img" src={space} alt="space-tourism" />
              </a>
